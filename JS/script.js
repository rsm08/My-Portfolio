...
//   const whatsappUrl = `https://api.whatsapp.com/send?phone=+919201756414&text=${encodeURIComponent(
//     whatsappMessage
//   )}`;
...
function openWhatsApp() {
  const phone = "919201756414"; // tumhara WhatsApp number

  const text = "Hi, I found your portfolio and would like to connect with you!";
